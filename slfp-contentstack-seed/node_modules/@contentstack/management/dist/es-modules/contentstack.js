...
export function client() {
  ...
  var defaultHostName = params.region ? getContentstackEndpoint(params.region.toUpperCase(), 'contentManagement', true) : getContentstackEndpoint('NA', 'contentManagement', true);
  if (params.host) {
