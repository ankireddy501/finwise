...
var OAuthHandler = /*#__PURE__*/function () {
  ...
  return (0, _createClass3["default"])(OAuthHandler, [{
        ...
        return _regenerator2["default"].wrap(function (_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              throw new Error(_errorMessages.ERROR_MESSAGES.OAUTH_BASE_URL_NOT_SET);
            case 1:
        ...
        return _regenerator2["default"].wrap(function (_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              throw new Error(_errorMessages.ERROR_MESSAGES.NO_REFRESH_TOKEN);
            case 1:
    ...
    value: function setAccessToken(token) {
      if (!token) {
        throw new Error(_errorMessages.ERROR_MESSAGES.ACCESS_TOKEN_REQUIRED);
      }
    ...
    value: function setRefreshToken(token) {
      if (!token) {
        throw new Error(_errorMessages.ERROR_MESSAGES.REFRESH_TOKEN_REQUIRED);
      }
    ...
    value: function setOrganizationUID(organizationUID) {
      if (!organizationUID) {
        throw new Error(_errorMessages.ERROR_MESSAGES.ORGANIZATION_UID_REQUIRED);
      }
    ...
    value: function setUserUID(userUID) {
      if (!userUID) {
        throw new Error(_errorMessages.ERROR_MESSAGES.USER_UID_REQUIRED);
      }
    ...
    value: function setTokenExpiryTime(expiryTime) {
      if (!expiryTime) {
        throw new Error(_errorMessages.ERROR_MESSAGES.TOKEN_EXPIRY_REQUIRED);
      }
        ...
        return _regenerator2["default"].wrap(function (_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              break;
            case 5:
              throw new Error(_errorMessages.ERROR_MESSAGES.AUTH_CODE_NOT_FOUND);
            case 6:
            case "end":
        ...
        return _regenerator2["default"].wrap(function (_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              throw new Error(_errorMessages.ERROR_MESSAGES.NO_USER_AUTHORIZATIONS);
            case 3:
              return _context7.abrupt("return", currentUserAuthorization[0].authorization_uid);
            case 4:
              throw new Error(_errorMessages.ERROR_MESSAGES.NO_APP_AUTHORIZATIONS);
            case 5:
              _context7.next = 7;
              break;
            case 6:
