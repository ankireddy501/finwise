...
function client() {
  ...
  var defaultHostName = params.region ? (0, _utils.getContentstackEndpoint)(params.region.toUpperCase(), 'contentManagement', true) : (0, _utils.getContentstackEndpoint)('NA', 'contentManagement', true);
  if (params.host) {
